...
<div class="container mt-3">
    <h1 class="text-center">Selamat Datang, <strong>Admin!</strong></h1>
    <p class="text-center">Gunakan menu di atas untuk mengelola data DPT, koordinator Pilkada, Statistik dan Berita.</p>
</div>

<!-- Statistik-->
<div class="container mt-4">
    <canvas id="pemilihChart" width="100" height="33vh"></canvas>
</div>
<script>
